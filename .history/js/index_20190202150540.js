...
function getTotalPrice(result) {
   ...
   var num = [getQuantity,getInput];
  


  //  var elements = document.getElementsByClassName("container").elements;

for (var i = 0; i < num.length; i++) {
    if (num.type === "text" && num.value === "") {
          document.getElementsByClassName("totalP")[0].innerHTML = "Please Enter Numbers";
        } else {
          var result = getQuantity * getInput;
          document.getElementsByClassName("totalP")[0].innerHTML = "Total price is = $" + result[i];
