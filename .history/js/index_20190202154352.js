...
function getPrice(result) {
  var getQuantity = parseInt(document.getElementById('newPrice').value); 
  var getInput = parseFloat(document.getElementById('newQty').value);
  result = getQuantity * getInput;
...
document.querySelector("#product-form").addEventListener("submit", createNewItemRow);
//delete product
