  ...
  document.getElementById("calc-prices-button").addEventListener("click", getTotal);
...
function getTotal(result) {
  var getPrice = parseInt(document.getElementById('fPrice').value); 
  console.log(getPrice);
  var getQua = parseFloat(document.getElementById('fQua').value);
  result = getPrice * getQua;
   if (!result) {
   document.getElementById("fTotal")[0].innerHTML = "Please Enter Numbers";
 } else {
   document.getElementById("fTotal")[0].innerHTML = "Total price is = $" + result;
  //  getProducts();
 }
}
