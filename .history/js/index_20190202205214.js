...
function getTotalPrice(result, second) {
  ...
  var sQua = parseInt(document.getElementsByClassName('costUnit').value); 
  var sInput = parseFloat(document.getElementsByClassName('quantity').value);
  var second = sQua * sInput;

  if (!second) {
    document.getElementsByClassName("totalP-2")[0].innerHTML = "Please Enter Numbers";
  } else {
    document.getElementsByClassName("totalP-2")[0].innerHTML = "Total price is = $" + second;
  }
