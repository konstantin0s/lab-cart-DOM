...
function getTotal() {
  ...
  for (var i = 1; i <= totalItems; i++) {
    var getQua = parseInt(document.getElementById('quantity-'+i).value);
    var getPrice = parseInt(document.getElementById('costUnit-'+i).value);
    if (typeof getPrice === "undefined" || getPrice === null) {
      document.getElementsByClassName("totalP")[0].innerHTML = "no product";
    } 
    total = total + getPrice * getQua;
  }

  document.getElementsByClassName("totalP")[0].innerHTML = "Total price is = $" + total;

// var result = getPrice * getQua;
//  if (!result) {
//  document.getElementsByClassName("totalP-1")[0].innerHTML = "Please Enter Numbers";
// } else {
...
// function getTotalPrice(result, second) {
