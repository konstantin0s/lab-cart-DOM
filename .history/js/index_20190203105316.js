...
function getTotalPrice(itemNode) {
  var getQuantity = parseFloat(document.getElementById('price-'+i).innerHTML); 

  // var getInput = parseFloat(document.getElementById('quantity').value);
  var total = 0;
   for (var i = 1; i < totalItems; i++) {
    itemNode = document.getElementById("quantity-"+i);
 
      // itemNode = getQuantity * getInput;
      total = total  + parseInt(itemNode.value) * getQuantity;
