...
function getTotalPrice() {
  ...
  var cartTotalPrice = document.querySelector("#sumtotalP span");
  cartTotalPrice.innerText = 0;

  for (var i = 0; i < products.length; i++) {          
    products[i].querySelector(".price span").innerText = Number(Number(products[i].querySelector(".price span").innerText) * Number(products[i].querySelector(".qInput span").value));    
