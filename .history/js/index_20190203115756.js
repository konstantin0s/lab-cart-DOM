...
function getTotalPrice() {
  ...
  for (var i = 0; i < products.length; i++) {          
   var ouput =  products[i].querySelector(".price span").innerText = Number(Number(products[i].querySelector(".price span").innerText) * Number(products[i].querySelector(".quantity").value)); 
   console.log(ouput);
