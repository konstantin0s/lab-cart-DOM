...
function getTotalPrice() {  //works individual products
  ...
  var output = products[i].querySelector(".totalP span").innerText = Number(Number(products[i].querySelector(".price span").innerText) * Number(products[i].querySelector(".quantity").value)); 
  console.log(output);
