  ...
  // document.querySelector("#product").addEventListener("click", deleteItem);
...
var button = document.getElementsByClassName("btn-danger").addEventListener
("click", deleteItem);

function deleteItem(e){
  var butt = document.querySelector('.product');
  this.remove();
 getTotalPrice();
}
